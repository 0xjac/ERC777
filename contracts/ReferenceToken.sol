...
contract ReferenceToken is Owned, ERC20Token, ERC777Token, EIP820Implementer {
    ...
    /// @notice Helper function that checks for ERC777TokensReceiver on the recipient and calls it.
    ...
    /// @param _operatorData Data generated by the operator to be passed to the recipient
    /// @param _preventLocking `true` if you want this function to throw when tokens are sent to a contract not
    ///  implementing `ERC777TokensReceiver`.
    ///  ERC777 native Send functions MUST set this parameter to `true`, and backwards compatible ERC20 transfer
    ///  functions SHOULD set this parameter to `false`.
    function callRecipient(
        ...
        address recipientImplementation = interfaceAddr(_to, "ERC777TokensReceiver");
        if (recipientImplementation != 0) {
            ERC777TokensReceiver(recipientImplementation).tokensReceived(
