...
function erc20compatible() public constant returns (bool)
```
Indicate whether the token-contract is backwards compatible with [ERC-20](https://github.com/ethereum/EIPs/issues/20) and exposes the ERC-20 standard methods such as `transfer`, `approve`, `transferFrom`.
